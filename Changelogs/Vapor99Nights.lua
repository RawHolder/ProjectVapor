...
local function setTab(tabName)
    if tabName == "Changelog" then
        content.Text = "Vapor99Nights V1.0\n\nEnjoy using the best 99Nights script that's out there right now!\n\nGet this script viral, make content and tag #ProjectVapor #Vapor99Nights"
    end
    task.wait()
    updateScrollSize()
end
