...
local function setTab(tabName)
    if tabName == "Changelog" then
        content.Text = "VaporSellLemons V1.2\n\nChanges in this update:\n\n• Fixed AutoRebirth and added a new system for it\n• Improved AutoCollectFruit\n• Added Auto CashVine\n• Added Auto Cash Drop\n\nEnjoy using the best SellLemons script that's out there right now!\n\nGet this script viral, make content and tag #ProjectVapor #VaporSellLemons"
    end
    task.wait()
    updateScrollSize()
end
